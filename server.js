...
async function main() {
  await mongoose.connect("mongodb://localhost:27017/books-list");
...
async function seedData() {
  ...
  const codeComplete = new booksModal({
    ...
    description: 'Want to know how to write robust code irrespective of the architecture of a programming language? Then consider reading the Code Complete: A Practical Handbook of Software Construction. It comprehensively covers all the aspects of the structure of good code.',
    status: true,
    email: 'omar.nabeel.h@gmail.com',
  });
